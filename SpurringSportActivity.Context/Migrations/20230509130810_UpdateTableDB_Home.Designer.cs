...
namespace SpurringSportActivity.Context.Migrations
{
    ...
    [Migration("20230509130810_UpdateTableDB_Home")]
    partial class UpdateTableDBHome
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SpurringSportActivity.Repositories.Entities.PointsDetails", b =>
                {
                    b.HasOne("SpurringSportActivity.Repositories.Entities.CompanyPoints", "CompanyPoint")
                        .WithMany()
                        .HasForeignKey("CompanyPointId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SpurringSportActivity.Repositories.Entities.UserPoints", "UserPoint")
                        .WithMany()
                        .HasForeignKey("UserPointId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("CompanyPoint");
            ...
            modelBuilder.Entity("SpurringSportActivity.Repositories.Entities.PublicPoints", b =>
                {
                    ...
                    b.HasOne("SpurringSportActivity.Repositories.Entities.UsersDetails", "WinningUser")
                        .WithMany()
